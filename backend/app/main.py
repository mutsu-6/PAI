...
@app.get("/gifts/contact/{contact_id}", response_model=List[GiftResponse])
...
@app.put("/gifts/{gift_id}", response_model=GiftResponse)
...
@app.get("/gifts/suggestions/{contact_id}", response_model=List[GiftSuggestion])
...
@app.get("/conversations/contact/{contact_id}", response_model=List[ConversationResponse])
